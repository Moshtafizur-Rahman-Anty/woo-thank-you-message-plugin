...
class WCTYM_Settings_Page {
    ...
    public function add_settings_page() {
        add_options_page(
            __( 'Thank You Message Settings', 'wctym' ),
            __( 'Thank You Message', 'wctym' ),
            'manage_options',
            'wctym-settings',
...
public function register_settings()
{
    ...
    add_settings_section(
        'wctym_main_section',
        __('Customize Thank You Message', 'wctym'), // Makes the section title translatable
        null,
        'wctym-settings'
    );
    ...
    public function message_field_callback() {
        ...
        echo '<p class="description">' . esc_html__( 'Use placeholders like [customer_name], [order_id], [billing_email], [total].', 'wctym' ) . '</p>';
    }
    ...
    public function position_field_callback() {
        ...
        $positions = [
            'top_of_page'       => __( 'Top of Page', 'wctym' ),
            'above_order_table' => __( 'Above Order Table', 'wctym' ),
            'below_order_table' => __( 'Below Order Table', 'wctym' ),
            'bottom_of_page'    => __( 'Bottom of Page (Default)', 'wctym' ),
        ];
        ...
        echo '</select>';
        echo '<p class="description">' . esc_html__( 'Choose where the thank-you message should appear on the order received page.', 'wctym' ) . '</p>';
    }
    ...
    public function bg_color_field_callback() {
        ...
        echo '<p class="description">' . esc_html__( 'Leave empty to use default background style from plugin.', 'wctym' ) . '</p>';
    }
    ...
    public function text_color_field_callback() {
        ...
        echo '<p class="description">' . esc_html__( 'Leave empty to use default text color from plugin CSS.', 'wctym' ) . '</p>';
    }
    ...
    public function border_radius_field_callback() {
        ...
        echo '<p class="description">' . esc_html__( 'Optional border radius in pixels. Leave blank for default.', 'wctym' ) . '</p>';
    }

    // Render the full settings page
    public function render_settings_page() {
        echo '<div class="wrap">';
        echo '<h1>' . esc_html__( 'WooCommerce Thank You Message', 'wctym' ) . '</h1>';
